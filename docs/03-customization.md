...
| ------ | ------ | ------ | ------ |
| SOUND_MODE | Select which mode of operation a device should use. For a detailed explanation see [here](../usage#modes-of-operation).| `MULTI_ROOM`, `MULTI_ROOM_CLIENT`, `STANDALONE` | `MULTI_ROOM`, except for cases listed [here](../device-support). |
