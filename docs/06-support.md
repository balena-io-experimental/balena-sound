...
If you are experiencing a problem that is not listed in this troubleshooting section please feel free to reach us at our [forums](https://forums.balena.io) or open an [issue](https://github.com/balenalabs/balena-sound/issues/new) on our GitHub repository.
